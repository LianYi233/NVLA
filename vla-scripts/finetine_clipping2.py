...
CUDA_VISIBLE_DEVICES=0 torchrun --standalone --nnodes 1 --nproc_per_node 1 vla-scripts/finetune.py --vlm_path pretrained_models/prism-qwen25-extra-dinosiglip-224px-0_5b --config_file_path pretrained_models/configs --data_root_dir data/libero --dataset_name $data_name (in ./data/libero: libero_object_no_noops) --run_root_dir outputs --use_film False --num_images_in_input 2 --use_proprio True --use_lora True --use_fz False --use_minivlm True --image_aug True --num_steps_before_decay 200000 --max_steps 200005 --save_freq 5000 --save_latest_checkpoint_only False --merge_lora_during_training True --batch_size 4 --grad_accumulation_steps 4 --learning_rate 2e-4 --lora_rank 64 --use_pro_version True

10-29
---action_queries:--- base_model.model.action_queries.weight requires_grad= True
trainable params: 57,344 || all params: 1,356,347,968 || trainable%: 0.0042
# trainable params in proprio_projector: 811776
# trainable params in action_head: 179405348
# total trainable params: 180274468

save_path:
finetune_model: ./outputs/
eval_log_files: ./experiments/logs/EVAL-libero_object-openvla-2025_10_30-12_06_27.txt
visualization:  ./rollouts/vla-adapter/xxx/xxx.mp4
"""
